...
public class GDataTestScripts {
  ...
  public static class Calendar {
    ...
    public static String testCalendars_Feed_Title = "GWT GData's Calendar List";
    ...
    public static String testCalendar_Entry_AuthorName = "GWT GData";
  ...
  public static class GoogleBase {
    ...
    public static String testItem_Entry_Link = "http://www.google.com/base/feeds/items/6597494054140337341";
    public static String testItem_Entry_Author = "Gwt-Gdata";
    public static String testItem_Entry_Author_Created = "Gwt-Gdata";
    public static String testItem_Entry_Published = "Fri Jun 12 00:17:26 EDT 2009";
