 ...
 */
public class FamilyName extends JavaScriptObject {

  /**
   * Constructs a family name.
   * 
   * @return A FamilyName object.
   */
  public static native FamilyName newInstance() /*-{
    return new $wnd.google.gdata.FamilyName();
  }-*/;
