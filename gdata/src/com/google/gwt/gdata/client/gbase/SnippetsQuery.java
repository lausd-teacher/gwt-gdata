...
public class SnippetsQuery extends Query {
   ...
   * @return A SnippetsQuery object.
   */
  public static native SnippetsQuery newInstance(String feedUri) /*-{
    return new $wnd.google.gdata.gbase.SnippetsQuery(feedUri);
  }-*/;
   ...
   * 
   * @param updatedMin Minimum updated date or an equivalent string value.
   */
