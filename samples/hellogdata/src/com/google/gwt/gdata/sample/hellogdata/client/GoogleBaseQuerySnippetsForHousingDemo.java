...
public class GoogleBaseQuerySnippetsForHousingDemo extends GDataDemo {
    ...
    return new GDataDemoInfo() {
      ...
      public String getDescription() {
        return "<p>This sample code uses a snippets query to find an items corresponding " +
          "to housing matching a set of criteria.</p>\n";
      }
  ...
  public GoogleBaseQuerySnippetsForHousingDemo() {
    service = GoogleBaseService.newInstance("HelloGData_GoogleBase_QuerySnippetsForHousingDemo_v1.0");
  ...
  public void startDemo() {
    ...
    query.setBq("[item type:housing][listing type:for sale][location:@\"San Jose, CA, USA\"+15mi][price < 700000 USD]");
