...
public class ExperimentFeed
   ...
   * 
   * @return An instance of ExperimentFeed.
   */
  @SuppressWarnings("unchecked")
  public static native ExperimentFeed newInstance() /*-{
    return new $wnd.google.gdata.analytics.ExperimentFeed();
  }-*/;

  protected ExperimentFeed() { }
