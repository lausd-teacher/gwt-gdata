...
public class FeatureFeed extends com.google.gwt.gdata.client.Feed<FeatureEntry> {
  ...
  /**
   * Constructs a feature feed using an object parameter whose property names match the setter method to use for each property.
   */
  public static native FeatureFeed newInstance(JavaScriptObject params) /*-{
