...
public class AbPageVariationFeed
   ...
   * 
   * @return An instance of AbPageVariationFeed.
   */
  @SuppressWarnings("unchecked")
  public static native AbPageVariationFeed newInstance() /*-{
    return new $wnd.google.gdata.analytics.AbPageVariationFeed();
  }-*/;

  protected AbPageVariationFeed() { }
