...
/**
 * Tests for the SyncEventProperty class.
 */
public class SyncEventPropertyTest extends GWTTestCase {
  @Override
  ...
  public void testProperties() {
    SyncEventProperty obj = SyncEventProperty.newInstance(JavaScriptObject.createObject());
    boolean value = true;
    obj.setValue(value);
