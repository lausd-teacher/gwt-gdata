...
public class GDataTestSuite extends GWTTestSuite {
  public static Test suite() {
    ...
    suite.addTestSuite(com.google.gwt.gdata.client.atom.FeedTest.class);
    ...
    suite.addTestSuite(com.google.gwt.gdata.client.GoogleServiceTest.class);
    suite.addTestSuite(com.google.gwt.gdata.client.QueryTest.class);
    suite.addTestSuite(com.google.gwt.gdata.client.ServiceTest.class);
    ...
    suite.addTestSuite(com.google.gwt.gdata.client.DateTimeTest.class);
    ...
    suite.addTestSuite(com.google.gwt.gdata.client.EntryTest.class);
    ...
    suite.addTestSuite(com.google.gwt.gdata.client.EventFeedTest.class);
    ...
    suite.addTestSuite(com.google.gwt.gdata.client.FeedTest.class);
